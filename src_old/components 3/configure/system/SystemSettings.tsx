    ...
    <div className="p-6">
      ...
      <div className="mb-6 bg-gradient-to-r from-fw-wash to-fw-base border border-fw-secondary rounded-lg p-4">
        <div className="flex items-start">
          ...
          <div>
            <h3 className="text-sm font-medium text-fw-heading">System Configuration</h3>
      ...
      <div className="flex">
        ...
        <div className="flex-1 pl-6">
          ...
          {activeView === 'general' && (
            <div className="space-y-6">
              <div className="bg-fw-base rounded-lg border border-fw-secondary p-6">
                <h3 className="text-lg font-semibold text-fw-heading mb-4">General System Settings</h3>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">System Timezone</label>
                      <select
                      ...
                      <p className="text-xs text-fw-bodyLight mt-1">Default timezone for all system operations</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-fw-bodyLight mt-1">Date display format</p>
                    </div>

                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">Session Timeout (minutes)</label>
                      <input
                        type="number"
                        min="5"
                        max="1440"
                        ...
                        className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link"
                      />
                      <p className="text-xs text-fw-bodyLight mt-1">Inactive session timeout</p>
                    </div>

                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">API Rate Limit (requests/min)</label>
                      <input
                        type="number"
                        min="100"
                        max="10000"
                        ...
                        className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link"
                      />
                      <p className="text-xs text-fw-bodyLight mt-1">Maximum API requests per minute per user</p>
                    </div>

                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">Default Theme</label>
                      <select
                        value={general.theme}
                      ...
                      <p className="text-xs text-fw-bodyLight mt-1">Default UI theme for new users</p>
                    </div>

                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">Language</label>
                      <select
                      ...
                      <p className="text-xs text-fw-bodyLight mt-1">Default system language</p>
                    </div>
                  </div>
                </div>
              ...
              {!canManageSecurity.allowed ? (
                ...
                <div className="space-y-6">
                  <label className="flex items-start space-x-3">
                    ...
                    />
                    <div>
                      <span className="text-sm font-medium text-fw-body">Require Multi-Factor Authentication</span>
                      <p className="text-xs text-fw-bodyLight mt-1">All users must enable MFA to access the system</p>
                    </div>
                  </label>
                  ...
                  <label className="flex items-start space-x-3">
                    ...
                    />
                    <div>
                      <span className="text-sm font-medium text-fw-body">Enable Single Sign-On (SSO)</span>
                      <p className="text-xs text-fw-bodyLight mt-1">Allow authentication via SAML/OAuth providers</p>
                    </div>
                  </label>
                  ...
                  <label className="flex items-start space-x-3">
                    ...
                    />
                    <div>
                      <span className="text-sm font-medium text-fw-body">Enable Audit Logging</span>
                      <p className="text-xs text-fw-bodyLight mt-1">Log all user actions and system changes for compliance</p>
                    </div>
                  </label>

                  <div className="pt-4 border-t border-fw-secondary">
                    <h4 className="text-sm font-semibold text-fw-heading mb-4">Password Policy</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-sm font-medium text-fw-body mb-2">Minimum Password Length</label>
                        <input
                          type="number"
                          min="8"
                          max="32"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-fw-body mb-2">Password Expiry (days)</label>
                        <input
                          type="number"
                          min="0"
                          max="365"
                          ...
                          className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link"
                        />
                        <p className="text-xs text-fw-bodyLight mt-1">0 = never expires</p>
                      </div>

                      <div>
                        <label className="block text-sm font-medium text-fw-body mb-2">Failed Login Lockout</label>
                        <input
                          type="number"
                          min="3"
                          max="10"
                          ...
                          className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link"
                        />
                        <p className="text-xs text-fw-bodyLight mt-1">Lock account after this many failed attempts</p>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 space-y-3">
                      <label className="flex items-center space-x-2">
                        ...
                        />
                        <span className="text-sm text-fw-body">Require special characters</span>
                      </label>
                      <label className="flex items-center space-x-2">
                        <input
                          type="checkbox"
                          ...
                          className="h-4 w-4 text-fw-link focus:ring-fw-link border-gray-300 rounded"
                        />
                        <span className="text-sm text-fw-body">Require numbers</span>
                      </label>
                    </div>
                  </div>

                  <div className="pt-4 border-t border-fw-secondary">
                    <h4 className="text-sm font-semibold text-fw-heading mb-4">IP Whitelisting</h4>
                    <label className="flex items-start space-x-3 mb-3">
                      ...
                      />
                      <div>
                        <span className="text-sm font-medium text-fw-body">Enable IP Whitelisting</span>
                        <p className="text-xs text-fw-bodyLight mt-1">Only allow access from approved IP addresses</p>
                      </div>
                    </label>

                    {security.ipWhitelistEnabled && (
                      <div>
                        <label className="block text-sm font-medium text-fw-body mb-2">Whitelisted IPs (one per line)</label>
                        <textarea
                          value={security.ipWhitelist}
                          onChange={(e) => setSecurity({...security, ipWhitelist: e.target.value})}
                          rows={5}
                          placeholder="192.168.1.0/24&#10;10.0.0.0/8"
                          className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link font-mono text-sm"
                        />
                      </div>
                    )}
                  </div>
          ...
          {activeView === 'backup' && (
            <div className="space-y-6">
              <div className="bg-fw-base rounded-lg border border-fw-secondary p-6">
                <h3 className="text-lg font-semibold text-fw-heading mb-4">Backup & Recovery Configuration</h3>
                <p className="text-sm text-fw-bodyLight mb-6">
                ...
                <div className="space-y-6">
                  <label className="flex items-start space-x-3">
                    ...
                    />
                    <div>
                      <span className="text-sm font-medium text-fw-body">Enable Automatic Backups</span>
                      <p className="text-xs text-fw-bodyLight mt-1">Automatically backup system data on a schedule</p>
                    </div>
                  </label>
                  ...
                  {backup.autoBackupEnabled && (
                    <>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          <label className="block text-sm font-medium text-fw-body mb-2">Backup Frequency</label>
                          <select
                        ...
                        <div>
                          <label className="block text-sm font-medium text-fw-body mb-2">Backup Time</label>
                          <input
                            type="time"
                            ...
                            className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link"
                          />
                          <p className="text-xs text-fw-bodyLight mt-1">Time to run daily/weekly backups</p>
                        </div>

                        <div>
                          <label className="block text-sm font-medium text-fw-body mb-2">Retention Period (days)</label>
                          <input
                            type="number"
                            min="7"
                            max="3650"
                            ...
                            className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link"
                          />
                          <p className="text-xs text-fw-bodyLight mt-1">How long to keep backup files</p>
                        </div>

                        <div>
                          <label className="block text-sm font-medium text-fw-body mb-2">Storage Provider</label>
                          <select
                      ...
                      <div>
                        <label className="block text-sm font-medium text-fw-body mb-2">Storage Location</label>
                        <input
                          type="text"
                          ...
                          className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link font-mono text-sm"
                        />
                        <p className="text-xs text-fw-bodyLight mt-1">Full path to backup storage location</p>
                      </div>

                      <div className="pt-4 border-t border-fw-secondary">
                        <h4 className="text-sm font-semibold text-fw-heading mb-3">Backup Content</h4>
                        <div className="space-y-3">
                          <label className="flex items-center space-x-2">
                            <input
                              ...
                              className="h-4 w-4 text-fw-link focus:ring-fw-link border-gray-300 rounded"
                            />
                            <span className="text-sm text-fw-body">Include system configurations</span>
                          </label>
                          <label className="flex items-center space-x-2">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 text-fw-link focus:ring-fw-link border-gray-300 rounded"
                            />
                            <span className="text-sm text-fw-body">Include connection data</span>
                          </label>
                          <label className="flex items-center space-x-2">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 text-fw-link focus:ring-fw-link border-gray-300 rounded"
                            />
                            <span className="text-sm text-fw-body">Include user data</span>
                          </label>
                          <label className="flex items-center space-x-2">
                            <input
                              type="checkbox"
                              ...
                              className="h-4 w-4 text-fw-link focus:ring-fw-link border-gray-300 rounded"
                            />
                            <span className="text-sm text-fw-body">Include system logs</span>
                          </label>
                        </div>
                      </div>
                      ...
                      <div className="pt-4 border-t border-fw-secondary space-y-3">
                        <label className="flex items-center space-x-2">
                          <input
                            ...
                            className="h-4 w-4 text-fw-link focus:ring-fw-link border-gray-300 rounded"
                          />
                          <span className="text-sm text-fw-body">Encrypt backup files (AES-256)</span>
                        </label>
                        <label className="flex items-center space-x-2">
                          <input
                            type="checkbox"
                            ...
                            className="h-4 w-4 text-fw-link focus:ring-fw-link border-gray-300 rounded"
                          />
                          <span className="text-sm text-fw-body">Compress backup files</span>
                        </label>
                      </div>

                      <div className="pt-4 border-t border-fw-secondary">
                        <h4 className="text-sm font-semibold text-fw-heading mb-3">Backup Actions</h4>
          ...
          {activeView === 'versioning' && (
            <div className="space-y-6">
              <div className="bg-fw-base rounded-lg border border-fw-secondary p-6">
                <h3 className="text-lg font-semibold text-fw-heading mb-4">Version Control Configuration</h3>
                <p className="text-sm text-fw-bodyLight mb-6">
                ...
                <div className="space-y-6">
                  <label className="flex items-start space-x-3">
                    ...
                    />
                    <div>
                      <span className="text-sm font-medium text-fw-body">Enable Version Control</span>
                      <p className="text-xs text-fw-bodyLight mt-1">Automatically track all configuration changes with version history</p>
                    </div>
                  </label>
                  ...
                  {versioning.enableVersionControl && (
                    <>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          <label className="block text-sm font-medium text-fw-body mb-2">Versioning Scope</label>
                          <select
                          ...
                          <p className="text-xs text-fw-bodyLight mt-1">What to version automatically</p>
                        </div>

                        <div>
                          <label className="block text-sm font-medium text-fw-body mb-2">Max Versions Per Resource</label>
                          <input
                            type="number"
                            min="10"
                            max="500"
                            ...
                            className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link"
                          />
                          <p className="text-xs text-fw-bodyLight mt-1">Maximum version history to keep</p>
                        </div>

                        <div>
                          <label className="block text-sm font-medium text-fw-body mb-2">Version Retention (days)</label>
                          <input
                            type="number"
                            min="30"
                            max="3650"
                            ...
                            className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link"
                          />
                          <p className="text-xs text-fw-bodyLight mt-1">How long to keep version history</p>
                        </div>
                      </div>
                      ...
                      <div className="pt-4 border-t border-fw-secondary space-y-3">
                        <label className="flex items-start space-x-3">
                          ...
                          />
                          <div>
                            <span className="text-sm font-medium text-fw-body">Auto-Version on Change</span>
                            <p className="text-xs text-fw-bodyLight mt-1">Create new version automatically whenever a resource is modified</p>
                          </div>
                        </label>
                        ...
                        <label className="flex items-start space-x-3">
                          ...
                          />
                          <div>
                            <span className="text-sm font-medium text-fw-body">Require Change Comments</span>
                            <p className="text-xs text-fw-bodyLight mt-1">Users must provide a comment describing their changes</p>
                          </div>
                        </label>
                        ...
                        <label className="flex items-start space-x-3">
                          ...
                          />
                          <div>
                            <span className="text-sm font-medium text-fw-body">Enable Rollback</span>
                            <p className="text-xs text-fw-bodyLight mt-1">Allow reverting to previous versions of configurations</p>
                          </div>
                        </label>
                        ...
                        <label className="flex items-start space-x-3">
                          ...
                          />
                          <div>
                            <span className="text-sm font-medium text-fw-body">Snapshot Before Major Changes</span>
                            <p className="text-xs text-fw-bodyLight mt-1">Create full system snapshot before major updates or migrations</p>
                          </div>
                        </label>
                        ...
                        <label className="flex items-start space-x-3">
                          ...
                          />
                          <div>
                            <span className="text-sm font-medium text-fw-body">Notify on Version Changes</span>
                            <p className="text-xs text-fw-bodyLight mt-1">Send notifications when resources are versioned</p>
                          </div>
                        </label>
                      </div>

                      <div className="pt-4 border-t border-fw-secondary">
                        <h4 className="text-sm font-semibold text-fw-heading mb-3">Version Management</h4>
            ...
            <div className="space-y-6">
              <div className="bg-fw-base rounded-lg border border-fw-secondary p-6">
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">Data Retention (days)</label>
                      <input
                        type="number"
                        min="30"
                        max="3650"
                        ...
                        className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link"
                      />
                      <p className="text-xs text-fw-bodyLight mt-1">General operational data retention</p>
                    </div>

                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">Log Retention (days)</label>
                      <input
                        type="number"
                        min="7"
                        max="365"
                        ...
                        className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link"
                      />
                      <p className="text-xs text-fw-bodyLight mt-1">System and application logs</p>
                    </div>

                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">Metrics Retention (days)</label>
                      <input
                        type="number"
                        min="30"
                        max="1095"
                        ...
                        className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link"
                      />
                      <p className="text-xs text-fw-bodyLight mt-1">Performance and monitoring metrics</p>
                    </div>

                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">Audit Log Retention (days)</label>
                      <input
                        type="number"
                        min="365"
                        max="3650"
                        ...
                        className="w-full px-4 py-2 border border-fw-secondary rounded-lg focus:ring-2 focus:ring-fw-link focus:border-fw-link"
                      />
                      <p className="text-xs text-fw-bodyLight mt-1">Compliance and audit logs (min 1 year)</p>
                    </div>
                  </div>
                  ...
                  <div className="pt-4 border-t border-fw-secondary space-y-3">
                    <label className="flex items-start space-x-3">
                      ...
                      />
                      <div>
                        <span className="text-sm font-medium text-fw-body">Automatically Delete Old Data</span>
                        <p className="text-xs text-fw-bodyLight mt-1">Remove data that exceeds retention period</p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-start space-x-3">
                      ...
                      />
                      <div>
                        <span className="text-sm font-medium text-fw-body">Archive Before Delete</span>
                        <p className="text-xs text-fw-bodyLight mt-1">Move data to archive storage before permanent deletion</p>
                      </div>
                    </label>

                    {data.archiveBeforeDelete && (
                      <div className="ml-7">
                        <label className="block text-sm font-medium text-fw-body mb-2">Archive Location</label>
                        <input
                          type="text"
                    ...
                    <label className="flex items-start space-x-3">
                      ...
                      />
                      <div>
                        <span className="text-sm font-medium text-fw-body">GDPR Compliant Mode</span>
                        <p className="text-xs text-fw-bodyLight mt-1">Enable data subject rights and privacy controls</p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-start space-x-3">
                      ...
                      />
                      <div>
                        <span className="text-sm font-medium text-fw-body">Anonymize Old Data</span>
                        <p className="text-xs text-fw-bodyLight mt-1">Remove PII from aged data for privacy compliance</p>
                      </div>
                    </label>
                  </div>
                </div>
          ...
          {activeView === 'maintenance' && (
            <div className="space-y-6">
              <div className="bg-fw-base rounded-lg border border-fw-secondary p-6">
                <h3 className="text-lg font-semibold text-fw-heading mb-4">Maintenance Configuration</h3>
                <p className="text-sm text-fw-bodyLight mb-6">
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">Maintenance Day</label>
                      <select
                    ...
                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">Maintenance Time</label>
                      <input
                        type="time"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">Maintenance Duration (minutes)</label>
                      <input
                        type="number"
                        min="30"
                        max="480"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-fw-body mb-2">Update Channel</label>
                      <select
                  ...
                  <div className="pt-4 border-t border-fw-secondary space-y-3">
                    <label className="flex items-start space-x-3">
                      ...
                      />
                      <div>
                        <span className="text-sm font-medium text-fw-body">Enable Automatic Updates</span>
                        <p className="text-xs text-fw-bodyLight mt-1">Apply system updates automatically during maintenance window</p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-start space-x-3">
                      ...
                      />
                      <div>
                        <span className="text-sm font-medium text-fw-body">Notify Users Before Maintenance</span>
                        <p className="text-xs text-fw-bodyLight mt-1">Send advance notification about upcoming maintenance</p>
                      </div>
                    </label>

                    {maintenance.notifyUsersBeforeMaintenance && (
                      <div className="ml-7">
                        <label className="block text-sm font-medium text-fw-body mb-2">Notification Lead Time (hours)</label>
                        <input
                          type="number"
                          min="1"
                          max="168"
