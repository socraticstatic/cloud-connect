...
export function RestrictedIPv4Policy() {
    ...
    <div className="space-y-8">
      <div className="card">
        <div className="card-header bg-fw-wash">
          <h2 className="text-figma-lg font-bold text-fw-heading tracking-[-0.03em] tracking-[-0.03em]">Restricted IPV4 Configuration</h2>
        </div>
