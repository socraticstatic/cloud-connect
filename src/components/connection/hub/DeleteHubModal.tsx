      ...
      <div className="bg-fw-base rounded-xl shadow-2xl max-w-md w-full overflow-hidden">
        ...
        <div className="p-6">
          <div className="flex items-start mb-5">
            ...
            <div className="ml-4">
              <h4 className="text-base font-medium text-fw-heading tracking-[-0.03em]">Are you sure you want to delete this Hub?</h4>
              <p className="mt-1 text-figma-base text-fw-bodyLight">
                Hub <span className="font-semibold">{cloudRouterName}</span> will be permanently removed.
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-figma-base text-fw-error mt-1">
                  Deleting this Hub will remove all associated links and functions. This may cause network disruption for connected systems.
                </p>
              </div>
            </div>
          </div>
